...
ActiveRecord::Schema.define(version: 20150305145551) do
  ...
  add_index "livraisons", ["commande_id"], name: "index_livraisons_on_commande_id"
  add_index "livraisons", ["user_id"], name: "index_livraisons_on_user_id"
  ...
  add_index "plats", ["menu_id"], name: "index_plats_on_menu_id"

  create_table "restaurants", force: true do |t|
    t.string   "nom"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "mock_restaurateur"

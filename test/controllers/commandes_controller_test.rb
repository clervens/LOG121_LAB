...
class CommandesControllerTest < ActionController::TestCase
  ...
  test "should create commande" do
    assert_difference('Commande.count') do
      post :create, commande: { date_de_livraison: @commande.date_de_livraison, numero: @commande.numero, restaurant_id: @commande.restaurant_id }
    end
  ...
  test "should update commande" do
    patch :update, id: @commande, commande: { date_de_livraison: @commande.date_de_livraison, numero: @commande.numero, restaurant_id: @commande.restaurant_id }
    assert_redirected_to commande_path(assigns(:commande))
  end
